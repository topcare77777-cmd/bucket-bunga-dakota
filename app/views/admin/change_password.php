...
<head>
    ...
    <title>Ganti Password - Dakota Admin</title>
    ...
    <div class="flex flex-col md:flex-row min-h-screen w-full">
        ...
        <aside class="w-full md:w-64 bg-slate-900 text-white flex flex-col flex-shrink-0 md:min-h-screen p-4">
            ...
            <nav class="space-y-1 flex-1">
                ...
                <a href="/admin/change-password" class="block py-2.5 px-4 rounded bg-slate-800 text-sky-400 font-medium transition">🔒 Ganti Password</a>
        ...
        <main class="flex-1 p-4 md:p-8 w-full max-w-full overflow-x-hidden">
            <header class="mb-6 md:mb-8">
                <span class="text-sm text-slate-500 font-medium">Keamanan Akun</span>
                <h1 class="text-2xl font-bold text-slate-900 mt-1">🔒 Ganti Password Admin</h1>
            </header>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 md:p-8 max-w-lg w-full">
                ...
                <form action="/admin/change-password" method="POST" class="space-y-5">
                    <div>
                    ...
                    <button type="submit" class="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3 min-h-[44px] rounded-lg shadow-sm transition mt-2">
                        Perbarui Password
                    </button>
                </form>
            </div>
